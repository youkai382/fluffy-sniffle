...
- Os lembretes chegam por DM com o botão de reação pronto; basta reagir ao aviso privado para contar o progresso e receber um elogio fofo.
...
- Cada DM de rotina traz um link direto para o anúncio do dia — abra e confirme por lá para encerrar o lembrete.
